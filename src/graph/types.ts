...
export type OperatorDefinition={id:string;label:string;family:OperatorFamily;category:OperatorCategory;description:string;inputs:PortDefinition[];outputs:PortDefinition[];defaults:Record<string,unknown>;runtime:'ready'|'planned'}
